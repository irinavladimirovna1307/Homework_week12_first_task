...
// 2. Добавьте перенос строки после каждого символа ";"
const result = text.replace(/;/g, ";\n");

// 3. Удалите все пробелы в переменной result
...
const newText = result.substring(27, 50); //В JavaScript индексация начинается с 0, поэтому 28-й символ находится на 27-м индексе.
...
// 6. Приведите текст в переменной result к верхнему регистру
const replacedText2 = result.toUpperCase();

// 7. Замените все вхождения слова клён на дуб в переменной result
const replacedText3 = result.replace(/клён/g, "дуб");

// 8. Найдите индекс первого вхождения слова моря в тексте
const index = text.indexOf("моря");

// 9. Измените только первую букву в переменной replacedText на заглавную
const modifiedText =
  replacedText.charAt(0).toUpperCase() + replacedText.slice(1);

// 10. Вывод всех результатов в консоль
